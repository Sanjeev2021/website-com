const getTechSkills = () => {
  $.ajax({
    ...
    dataType: "json",
    type: "GET",
    url: "https://tsm.swabhavtechlabs.com/api/v1/tsam/tenant/7ca2664b-f379-43db-bdf9-7fdd40707219/tech-skill",
  })
    .done(function (response) {
      console.log(response);
      const selectContainer = document.getElementById("tech-skill");
      response.forEach(item => {
        const optionContainer = document.createElement("option")
        optionContainer.appendChild(document.createTextNode(" " + item.name));
        ...
        // if (container && label && optionContainer) {
